...
const ICON_MOON = window.BASE_URL + '/assets/icons/moon-stars-fill.svg';
...
function renderAdminTopBar() {
    ...
    topBar.innerHTML = `
        <button class="mobile-menu-btn" type="button" id="mobileMenuBtn" aria-label="Open menu">
            <img src="${window.BASE_URL}/assets/icons/list.svg" alt="" class="bi">
        </button>
        <div class="topbar-actions">
            <button class="btn-logout" type="button" id="adminLogoutBtn">
                <img src="${window.BASE_URL}/assets/icons/box-arrow-left.svg" alt="" class="bi">
                <span>Logout</span>
            </button>
        </div>
    `;
